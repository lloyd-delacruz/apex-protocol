...
const Step15Join = ({ onNext, onPrev }: StepProps) => (
  <View style={styles.stepContainer}>
    <View style={styles.headerRow}>
      <TouchableOpacity onPress={onPrev}>
        <Text style={{ color: colors.brandPrimary, fontSize: 18 }}>←</Text>
      </TouchableOpacity>
      <Text style={styles.headerTitle}>Join Apex Protocol</Text>
      <View style={{ width: 40 }} />
    </View>

    <Text style={[styles.title, { fontSize: 28, marginTop: 40 }]}>Your custom workout{'\n'}program is <Text style={styles.italic}>ready</Text></Text>
    <Text style={styles.subtitle}>Sign up below to save your profile and start training.</Text>
    ...
    <View style={{ gap: 12, marginTop: 20 }}>
      ...
      <TouchableOpacity style={styles.brandButton} onPress={onNext}>
        <Text style={styles.brandButtonText}>CONTINUE WITH EMAIL</Text>
      </TouchableOpacity>
    </View>
    ...
    <TouchableOpacity style={styles.loginCard}>
      <Text style={styles.loginCardText}>Log in with existing account</Text>
    </TouchableOpacity>

    <View style={{ flex: 1 }} />
    <Text style={styles.termsText}>
      By signing up, you agree to our <Text style={styles.linkText}>Privacy Policy</Text> and <Text style={styles.linkText}>Terms & Conditions</Text>
    </Text>
  </View>
);
...
export default function OnboardingScreen() {
  ...
  const renderStep = () => {
    switch (state.step) {
      ...
      case 5: return <Step5Environment onNext={nextStep} onPrev={prevStep} />;
      case 6: return <Step6Equipment onNext={nextStep} onPrev={prevStep} />;
      case 7: return <Step7CalibrationIntro onNext={nextStep} onPrev={prevStep} />;
      case 8: return <Step8BestLifts onNext={nextStep} onPrev={prevStep} />;
      case 9: return <Step9WeeklyGoal onNext={nextStep} onPrev={prevStep} />;
      case 10: return <Step10Notifications onNext={nextStep} onPrev={prevStep} />;
      case 11: return <Step11BodyStats onNext={nextStep} onPrev={prevStep} />;
      ...
      case 15: return <Step15Join onNext={nextStep} onPrev={prevStep} />;
      case 16: return <Step16Paywall />;
      default: return null;
    }
  };
